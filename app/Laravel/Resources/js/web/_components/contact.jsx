                        ...
                        <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                            ...
                            <form id="contactForm">
                                    ...
                                    <div className="mx-0 mb-1 sm:mb-4">
                                        <div className="mx-0 mb-1 sm:mb-4">
                                            ...
                                            <input
                                                ...
                                                className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 rounded-lg shadow-md sm:mb-0"
                                                name="name"
                                            />
                                        </div>
                                        <div className="mx-0 mb-1 sm:mb-4">
                                ...
                                <div className="text-center">
                                    <button
                                        type="submit"
                                        className="w-full bg-blueGray-600 active:bg-blueGray-700 text-white px-6 py-3 font-xl rounded-md sm:mb-0"
                                    >
                                        Send Message
                                    </button>
                                </div>
