...
export default function CategoriesCreate({ data }) {
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route('portal.categories.create'), values);
    }
    ...
    return(
        <Main>
            ...
            <Breadcrumb>
                ...
                <Breadcrumb.Separator />
                <Breadcrumb.Item>
                    <Breadcrumb.CurrentLink>Create Category</Breadcrumb.CurrentLink>
                </Breadcrumb.Item>
            </Breadcrumb>
            ...
            <div className="sm:w-full lg:w-[600px] mb-7">
                <Card>
                    <Card.Header>
                        <Typography tag="h6">Create Category</Typography>
                    </Card.Header>
                    <Card.Body>
